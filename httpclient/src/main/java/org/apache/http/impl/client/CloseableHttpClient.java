...
public abstract class CloseableHttpClient implements HttpClient, Closeable {
    ...
    private static HttpHost determineTarget(final HttpUriRequest request) throws ClientProtocolException {
        ...
        //by li.hzh
        MyLogFactory.getLog().info("First, determine the target of the request URI. [" + requestURI.toString() + "]");
        if (requestURI.isAbsolute()) {
            target = URIUtils.extractHost(requestURI);
            MyLogFactory.getLog().debug("Target http host is: [" + target + "].");
            if (target == null) {
    ...
    public CloseableHttpResponse execute(
        ...
        //by li.hzh
        MyLogFactory.getLog().debug("Execute request with NULL http context.");
